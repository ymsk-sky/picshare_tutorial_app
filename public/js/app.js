  ...
  methods: {
    ...
    onFileChange: function onFileChange(event) {
      ...
      reader.onload = function (e) {
        ...
        // previewに値が入ると<output>につけたi-ifがtrueと判定される
  ...
  return _c(
    ...
    [
      ...
      _c("div", { staticClass: "navbar__menu" }, [
        ...
        _vm._v(" "),
        _vm.isLogin
          ? _c("span", { staticClass: "navbar_item" }, [
              _vm._v("\n      " + _vm._s(_vm.username) + "\n    ")
            ])
          : _c(
              "div",
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "button",
      { staticClass: "button button--link", attrs: { title: "Like photo" } },
  ...
  function() {
    ...
    return _c("h2", { staticClass: "photo-detail__title" }, [
      _c("i", { staticClass: "icon ion-md-chatboxex" }),
      _vm._v("Comments\n    ")
    ])
  },
  function() {
